...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 14, 2020 at 01:58 PM
...
INSERT INTO `reviews` (`REVIEW_ID`, `REVIEW_RATING`, `REVIEW_DESCRIPTION`, `CUSTOMER_EMAIL`) VALUES
(1, 5, 'First Response, well behaviour, price are also good', 'mahir123@gmail.com'),
(2, 5, 'Quality of products are appreciated and price are also good', 'nuzhat123@gmail.com');
...
--
ALTER TABLE `processor`
  MODIFY `P_ID` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1122;
